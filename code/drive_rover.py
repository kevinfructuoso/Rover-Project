...
class RoverState():
    def __init__(self):
        ...
        self.sample_in_view = False
        self.near_sample = 0                # Will be set to telemetry value data["near_sample"]
        self.picking_up = 0                 # Will be set to telemetry value data["picking_up"]
        self.send_pickup = False            # Set to True to trigger rock pickup
        self.stalled_counter = 0            #counter used to determine if stalled
        self.tilted_counter = 0             #counter used to determine if tilted
        self.turn_start_yaw = 0             #attribute to save the angle that we started turning around from
        self.turn_steer = 0                 #attribute to save the direction we need to turn to get unstuck
